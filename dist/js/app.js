                ...
                var Share = function() {
                    ...
                    Share.prototype.setLgShareMarkup = function() {
                        ...
                        $shareButton.first().on("click.lg", (function() {
                            ...
                            if (_this.core.outer.hasClass("lg-dropdown-active")) _this.core.outer.attr("aria-expanded", true); else _this.core.outer.attr("aria-expanded", false);
                        }));
 ...
 */                var StickySidebar = function() {
                    ...
                    var StickySidebar = function() {
                        ...
                        _createClass(StickySidebar, [ {
                            ...
                            value: function extend(defaults, options) {
                                var results = {};
                                for (var key in defaults) if ("undefined" !== typeof options[key]) results[key] = options[key]; else results[key] = defaults[key];
                                return results;
                            }
                        }, {
                            key: "offsetRelative",
    ...
    (() => {
        ...
        class Popup {
            ...
            eventsPopup() {
                document.addEventListener("click", function(e) {
                    ...
                    } else if (buttonClose || !e.target.closest(`.${this.options.classes.popupContent}`) && this.isOpen) {
                        e.preventDefault();
                        this.close();
                        return;
                    }
        ...
        function initSliders() {
            if (document.querySelector(".card__slider")) new swiper_core_Swiper(".card__slider", {
            ...
            if (document.querySelector(".cards-main__slider")) {
            ...
            if (document.querySelector(".top-object-page__slider") && windowWidth < 768) new swiper_core_Swiper(".top-object-page__slider", {
            ...
            if (document.querySelector(".district__slider")) new swiper_core_Swiper(".district__slider", {
            ...
            if (document.querySelector(".object-apartment__slider")) new swiper_core_Swiper(".object-apartment__slider", {
                modules: [ Pagination, Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".gallery-slider")) {
                let gallerySlider = new swiper_core_Swiper(".gallery-slider", {
            ...
            if (document.querySelector(".command__slider")) new swiper_core_Swiper(".command__slider", {
                modules: [ Pagination, Navigation, freeMode ],
                observer: true,
                observeParents: true,
                speed: 800,
...
***************************************************************************** */
        ...
        var lg_share_umd = __webpack_require__(571);
        ...
        if (isMobile.any()) {
            ...
            if (arrows) for (let index = 0; index < arrows.length; index++) {
        ...
        if (document.querySelector(".wrapper-header-bg")) header.classList.add("header_bg");
        const itiInputs = document.querySelectorAll(".iti-input");
        if (itiInputs) for (let i = 0; i < itiInputs.length; i++) {
        ...
        if (!header.classList.contains("header_bg")) window.addEventListener("scroll", (function(e) {
            let scrollY = window.scrollY;
            if (scrollY > header.clientHeight) header.classList.add("header_bg"); else header.classList.remove("header_bg");
        }));
        function subtitleChange() {
            let subtitles = document.querySelectorAll(".top-card-info__subtitle");
            if (subtitles) for (let index = 0; index < subtitles.length; index++) {
                ...
                if (subtitle && subtitleContent) {
                    ...
                    if (subtitleHeightContent > subtitleHeight) subtitle.classList.add("_text-hide");
                }
            }
        }
        window.addEventListener("load", (function() {
            ...
            const onScrollHeader = () => {
                ...
                window.addEventListener("scroll", (() => {
                    ...
                    if (header && currentScroll > header.clientHeight) {
                        ...
                        if (currentScroll > prevScroll && !headerHidden()) document.documentElement.classList.add("header_hidden");
                        if (currentScroll < prevScroll && headerHidden()) document.documentElement.classList.remove("header_hidden");
            ...
            class GlowCursor {
                ...
                initCursor() {
                    ...
                    const render = () => {
                        ...
                        if (!this.isStuck) TweenMax.to(this.outerCursor, this.outerCursorSpeed, {
                            x: this.clientX - this.outerCursorBox.width / 2,
                            y: this.clientY - this.outerCursorBox.height / 2
                        });
