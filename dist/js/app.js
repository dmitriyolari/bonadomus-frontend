(() => {
    ...
    (() => {
        ...
        if (windowWidth < 768 && formFilter) formFilter.removeAttribute("data-simplebar"); else new SimpleBar(formFilter, {
            autoHide: false
        });
        ...
        let script_windowWidth = window.innerWidth;
        if (isMobile.any()) {
        ...
        if (document.querySelector(".page-catalog")) header.classList.add("header_bg");
